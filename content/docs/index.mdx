...
![Wrapped present](https://abs-0.twimg.com/emoji/v2/svg/1f381.svg) 🎁 **Rewards distributions** - Fixed cost distribution in a single transaction for any number of receivers.

🔮 **Anything you can imagine** - Superfluid is very flexible!

![Sparkles](https://abs-0.twimg.com/emoji/v2/svg/2728.svg)The first implementation consists of these key components:
