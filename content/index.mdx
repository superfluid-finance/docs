...
The Superfluid Protocol is a framework that realizes real-time finance. The first implementation of the framework is on Ethereum. Read more in the [docs](https://docs.superfluid.finance/docs).
