...
This step is optional, but allows alice's DAIx balance to be updated instantly when an Instant Distribution occurs.

Alice can **subscribe** to bob's Publishing Index using `approveSubscription()`. 
