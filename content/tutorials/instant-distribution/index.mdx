...
The "0.01" we passed represents 0.01 _DAIx per unit_. So since alice has 200 units, she receives `0.01 * 200 units = 2 DAIx`. Similarly, dan received 1 DAIx.

We can get the total amount distributed by multiplying the

the new index value we called) _ 300 Total Units = 3 DAI being distributed Since alice owns 100 Units, she earns 100 / 300 _ 3 DAI = 1 DAI Since dan owns 200 Units, he earns 200 / 300 * 3 DAI = 2 DAI
